...
const webOnlyKeys: Array<keyof TemperatureConverterPreviewProps> = ["advanced"];

export const advancedOptionKeys: Array<keyof TemperatureConverterPreviewProps> = [
    "decimalPrecision",
    "inputConversionRate",
    "placeholder",
    "onClickAction"
...
export function getProperties(
    ...
    hidePropertiesIn(defaultProperties, values, [
        ...keysToHideByTemp[values.inputConversionRate],  // Enum key --> values.EnumKey
    ]);
...
// export function check(_values: TemperatureConverterPreviewProps): Problem[] {
...
// export function getPreview(values: TemperatureConverterPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: TemperatureConverterPreviewProps, platform: Platform): string {
